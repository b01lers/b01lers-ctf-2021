...
r = process(["python3.7", "server.py", "0"])   # test server
...
r  = process(["python3.7", "server.py", "0"])   # test server
r2 = process(["python3.7", "server.py", "1"])   # real server -> could also use test server with test mode off
#r2 = process(["python3.7", "server.py", "2"])   # real server -> could also use test server with test mode off
